...
df['is_application'] = df.application_date.apply(lambda x: 'Application' 
                                                 if x is not None else 'No Application')
df['is_application']
...
finCont = [[200, 2304], [250, 2250]]
chi2_contingency(finCont)
...
plt.savefig('Visitors_apply_percent')
...
plt.savefig('Membership_apply_percent ')
...
plt.savefig('fin_Membership_visit_percent ')
